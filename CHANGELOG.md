...
- Emits the `F_READONLY` flag for object literal members when marked with `readonly` keyword and adds
  `ReflectedObjectMember#isReadonly` ([#103](https://github.com/typescript-rtti/typescript-rtti/issues/103))
